...
class MemoryStore:
    ...
    def _setup_schema(self):
        ...
        self.cur.execute("CREATE TABLE IF NOT EXISTS schema_version (version INTEGER PRIMARY KEY)")
        ...
        if version < 1:
            ...
            self.cur.execute("INSERT OR REPLACE INTO schema_version (version) VALUES (1)")
